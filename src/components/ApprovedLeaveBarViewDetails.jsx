...
const ApprovedLeaveBarViewDetails = ({ onClose }) => {
  return (
    <>
      <div className="approved-expanded-view">
        ...
        <div className="leave-bar-bottom">
          <div className="details-label-info">
            ...
            <p className="module">Internet Software Architecture</p>
          </div>
