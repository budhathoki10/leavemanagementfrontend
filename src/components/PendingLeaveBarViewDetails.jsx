...
import "../CSS/PendingLeaveBarViewDetails.css";

const PendingLeaveBarViewDetails = ({ leave, onClose }) => {
  ...
  return (
    <div className="pending-leave-details-overlay">
      <div className="pending-leave-details-card">
...
export default PendingLeaveBarViewDetails;
